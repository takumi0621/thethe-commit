    ...
    <div class="row">
        ...
        <div class="col-sm-8">
            <ul class="nav nav-tabs nav-justified mb-3">
                ...
                <li class="nav-item"><a href="{{ route('users.favoriting', ['id' => $user->id]) }}" class="nav-link {{ Request::is('users/*/favoriting') ? 'active' : '' }}">Favoriting <span class="badge badge-secondary">{{ $count_favoriting }}</span></a></li>
            </ul>
            @include('users.favorite-child', ['microposts' => $microposts])
        </div>
    </div>
@endsection